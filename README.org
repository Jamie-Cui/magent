...
The old one-shot ~delegate~ tool has been replaced by ~spawn_agent~, ~send_agent_message~, ~wait_agent~, ~list_agents~, and ~close_agent~. Codex sandbox behavior is intentionally out of scope. The final architecture is documented in [[file:docs/AGENT_JOBS.md][docs/AGENT_JOBS.md]], with historical implementation notes in [[file:docs/plans/2026-05-30-codex-agent-workflow-alignment.md][docs/plans/2026-05-30-codex-agent-workflow-alignment.md]].
