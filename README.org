...
(use-package magent
  ...
  ;; Optional: show the number of active Actions in the mode line.
...
| ~magent-action-mode-line-mode~                 | ~nil~                                 | Show the active Action count and current-Step details in the global mode line                    |
