;;; magent-fsm-tools.el --- FSM tool execution and permission helpers  -*- lexical-binding: t; -*-
...
;; Shared tool-execution helpers used by the active FSM implementation.
...
(provide 'magent-fsm-tools)
(provide 'magent-fsm-shared)
;;; magent-fsm-tools.el ends here
