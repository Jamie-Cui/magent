;;; magent-ui-legacy.el --- Legacy special-mode UI for Magent  -*- lexical-binding: t; -*-
...
;; Legacy Magent UI with a read-only workspace buffer and an independent
;; compose buffer.  This file is intentionally separate from the backend
;; router in magent-ui.el so the old UI can be removed without affecting the
;; agent-shell + ACP path.
...
(provide 'magent-ui-legacy)
;;; magent-ui-legacy.el ends here
