;;; magent-md2org.el --- Markdown to Org-mode converter  -*- lexical-binding: t; -*-
...
;; Converts markdown syntax to org-mode syntax for LLM output rendering.
;; Handles: headers (level +1), fenced code blocks, bold, italic, inline code.
;; Skips #+begin_tool/#+end_tool and #+begin_think/#+end_think blocks.
...
(defun magent-md2org-convert-string (text)
  "Convert markdown TEXT to org-mode string."
  (with-temp-buffer
    (insert text)
