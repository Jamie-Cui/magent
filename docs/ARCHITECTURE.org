...
completion. The standard prompt handler delegates one turn to
~magent-runtime-submit~; advanced trusted packages may own a longer async
invocation without receiving ACP or queue internals. The bundled
