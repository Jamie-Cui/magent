...
- ~magent-modeline.el~ — UI-neutral mode-line status formatting
...
frontend development boundary before changing this layer.
...
interactive experience; shared behavior must remain in the runtime API.
