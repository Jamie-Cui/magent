...
- `magent-ui.el` is the thin public command router, logger, compatibility shim,
  and `magent-ui-backend` switch point.
...
- `magent-ui-legacy.el` contains the old special-mode workspace, compose buffer,
  timeline rendering, transient menu, and legacy prompt dispatch.
