...
Management remains available even when no Action applies to the current buffer.
Both kinds of entry execute in the buffer from which the menu was opened.
