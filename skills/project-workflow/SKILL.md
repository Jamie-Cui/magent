...
type: instruction
tools: ["emacs_read", "emacs_eval_live", "grep", "glob", "bash"]
capability: true
family: project
source: package
source-name: project
...
features: ["project"]
prompt-keywords: ["project root", "current project", "switch project", "project file", "project buffer", "project compile"]
disclosure: active
risk: low
---
